...
// store.dispatch(postActions.publishPost("Uncle Sam", "pepetrueno123", 38, "Mi canción favorita para despertar."))
// store.dispatch(postActions.publishPost("Doug Las", "doug456", 10, "La mejor canción del nuevo álbum de Bad Bunny. La mejor canción del nuevo álbum de Bad Bunny. La mejor canción del nuevo álbum de Bad Bunny. La mejor canción del nuevo álbum de Bad Bunny."))
// store.dispatch(postActions.publishPost("Turn Table", "TTFire", 22, "Colores!"))
// store.dispatch(postActions.publishPost("Kendrick Duckworth", "kdotking", 7, "Dark Lane Demo Tapes es puro fuego!"))
